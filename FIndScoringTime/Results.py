...
def run_python_scripts():
    # 指定要執行的 Python 檔案
    first_script = "/home/cms/Desktop/FIndScoringTime/FindPY/findDB.py"  # 替換為第一個 Python 檔案的路徑
    second_script = "/home/cms/Desktop/FIndScoringTime/FindPY/findLOG.py"  # 替換為第二個 Python 檔案的路徑
    ...
    csv_output_path = "/home/cms/Desktop/FIndScoringTime/FindPY/csvData/findDB.csv"
